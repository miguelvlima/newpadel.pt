...
@section('content')
    <div>
        ...
        <section id="banner">
            <div>
                <img class="ementa" src="/images/NEW PADEL - EMENTA 2025 1.png" alt="New Padel Ementa"  onclick="window.open(this.src, '_blank');">
                <img class="ementa" src="/images/NEW PADEL - EMENTA 2025 2.png" alt="New Padel Ementa"  onclick="window.open(this.src, '_blank');">
            </div>
        </section>
        <!-- Footer -->
        <!-- Footer -->
