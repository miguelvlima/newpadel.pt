...
<head>
  ...
  :root{
    ...
    /* NOVO: baseline fixa da CÉLULA (evita crescer com o número) */
    --fs-cell: 26px;
  ...
  *{box-sizing:border-box}
  ...
  .scoretable td.set > .cell{
    ...
    /* baseline fixa da CÉLULA (não depende de --fs-set) */
    ...
    overflow: hidden;
    position: relative; /* para centrar o .num absolutizado */
  }

  /* === AGORA (mesma baseline fixa) === */
  ...
  .scoretable .cell-now .num{
    /* centrado absoluto + scale controlado em JS */
    position: absolute;
    left: 50%; top: 50%;
    ...
    /* baseline para cálculo; o “tamanho real” vem do scale() */
    font-size: 100px;
    font-weight: 900;
    font-variant-numeric: tabular-nums;
  }
...
<body>
  ...
  <script type="module" src="/js/filament/scoreboard.js?v=78"></script>
</body>
</html>
