...
@php
  // se preferires, põe as chaves diretamente aqui em vez do config()
...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* ocupar SEMPRE 100% do ecrã, sem scroll */
    main{
      flex:1; height:100%;
      padding:16px;
...
<body>
  ...
  <!-- Passo as credenciais ao JS via data-attributes, evitamos Blade dentro do <script> -->
  <main id="grid"
        data-sb-url="{{ $sbUrl }}"
        data-sb-anon="{{ $sbAnon }}">
  ...
  <script type="module" src="{{ asset('js/scoreboard.js') }}"></script>
</body>
</html>
