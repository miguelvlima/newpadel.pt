...
<body>
  ...
  <main id="grid">
    ...
    async function fetchGames(){
      ...
      const games = data || [];
      // fetch court names separately to avoid JOIN permission issues
